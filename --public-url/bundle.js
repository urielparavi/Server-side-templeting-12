...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidXJpZWxwYSIsImEiOiJjbTRzaXhjbmYwMTNpMnBxeWNxcXFpNGZjIn0.v-ZcJ_vnGfqkmFOr_PIoyA';
...
// const userDataForm = document.querySelector('.form-user-password');
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    // const navLinks = document.getElementsByClassName('.nav__el');
    // navLinks.addClass('.nav__el--cta');
  });
}
